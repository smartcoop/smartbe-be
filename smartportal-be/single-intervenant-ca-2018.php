...
<?php if (have_posts()): ?>
	...
	?>  
		<article id="content" role="main" class="container">
			<div class="retour_liste"><a href="http://smartbe.be/fr/news/intervenant-ag-2018/">< Retour à la liste des intervenants</a><br/><br/></div>		
			<div   id="fiche_candidat">
				...
				<div class="bloc_identity bloc2" style="float:right" >
					...
					<div>
						<h3><?php echo get_post_meta( get_the_ID(), 'fc_intervenants_organisation',true ); ?>
						</h3>
					</div>
					<div>
						<?php echo get_post_meta( get_the_ID(), 'fc_intervenants_fonction',true ); ?>
						<br/><br/>
					</div>
