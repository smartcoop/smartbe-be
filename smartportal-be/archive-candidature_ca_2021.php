<?php 
	/**
 * Template for the archives Candidature CA 2021
 */
	get_header(); 
	...
	if($lg =='nl'){
		$suffixe_lg = '_nl';
		$titre = 'Kandidaten voor de Raad van Bestuur van de Smart-coöperatie 2021-2025';
		...
		$suffixe_lg = '_fr';
		$titre = 'Candidats au Conseil d\'Administration de SmartCoop 2021-2025';
