...
<?php
	...
	if($lg =='nl'){
		...
		$menu="De coöperatie";
		$href_retour='/nl/news/candidature-ca-2022/';
		...
		$href_retour='/fr/news/candidature-ca-2022/';
	...
	$copyright = $mypod->display('copyright_photo');
			...
			<?php while (have_posts()) : the_post(); ?>
				...
				<div class="fiche_candidat">
					<div class="fiche_candidat_image">
						...
						<?php if($entite !=''){?>
							<div class="candidat_copyright">©<?php echo $copyright;?></div>
						<?php } ?>
					</div>
