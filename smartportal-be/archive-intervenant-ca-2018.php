...
<?php  query_posts('post_type=intervenant-ca-2018&showposts=100');if (have_posts()): ?>
...
<section id="content" role="main" class="container blog-archive-list">
	...
	<header id="page-title" class="page-leader">
		<h1 >
		  <?php
			echo 'INTERVENANTS ASSEMBLEE GENERALE LET’S COOP 2018 <br/><span class="grey">SPREKERS ALGEMENE VERGADERING LET’S COOP 2018</span>';
		  ?>
		</h1>
	</header>
	<div class="chapo">
		Consultez le programme entier <a href="http://smartbe.be/fr/programme-complet-assemblee-generale-2018/">ici</a><br/> 

		<span class="grey">Bekijk <a href="http://smartbe.be/nl/programme-complet-assemblee-generale-2018/">hier</a> het volledige programma</span> <br/><br/>
							...
							echo '<div class="vignette_candidat">';							
							   echo '<a href="'.get_permalink().'">';
										...
										echo '<div class="candidat_cat">';
											echo get_post_meta($post->ID,'fc_intervenants_organisation',true);				
										echo '</div>';
